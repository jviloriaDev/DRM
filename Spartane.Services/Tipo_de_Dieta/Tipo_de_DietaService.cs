    ...
    public partial class Tipo_de_DietaService : ITipo_de_DietaService
    {
        ...
        public int Update(Spartane.Core.Classes.Tipo_de_Dieta.Tipo_de_Dieta entity)
        {
            ...
            try
            {
                ...
                var empEntity =
                    _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.sp_UpdTipo_de_Dieta>("sp_UpdTipo_de_Dieta" , paramUpdClave , paramUpdDescripcion ).FirstOrDefault();
