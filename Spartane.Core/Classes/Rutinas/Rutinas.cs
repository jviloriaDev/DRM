...
namespace Spartane.Core.Classes.Rutinas
{
    ...
    public class Rutinas: BaseEntity
    {
        ...
        [ForeignKey("Intensidad")]
        public virtual Spartane.Core.Classes.Nivel_de_Intensidad.Nivel_de_Intensidad Intensidad_Nivel_de_Intensidad { get; set; }
        [ForeignKey("Genero")]
        public virtual Spartane.Core.Classes.Sexo.Sexo Genero_Sexo { get; set; }
        [ForeignKey("Estatus")]
