...
namespace Spartane.Core.Classes.Planes_de_Suscripcion
{
    ...
    public class Planes_de_Suscripcion: BaseEntity
    {
        ...
        public int? Tipo_de_Beneficiario { get; set; }
        ...
        [ForeignKey("Tipo_de_Beneficiario")]
        public virtual Spartane.Core.Classes.Tipo_de_Plan_de_Suscripcion.Tipo_de_Plan_de_Suscripcion Tipo_de_Beneficiario_Tipo_de_Plan_de_Suscripcion { get; set; }
        [ForeignKey("Estatus")]
